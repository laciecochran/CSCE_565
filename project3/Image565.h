...
public:
    ...
    int ReadPnmFile(char* filename);
    void WritePnmFile(ofstream& out, int norm);
    int WritePnmFile(char* filename, pnm_type type, int norm);
    void ReadRawFile(ifstream& in);
    void WriteRawFile(ofstream& out);
    int ReadRawFile(char* filename);
    int WriteRawFile(char* filename);
